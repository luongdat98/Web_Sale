...
<head>
    ...
    <!--[if lte IE 9]>
    <link rel="stylesheet" href="<c:url value="/resources/theme1/assets_admin/css/ace-part2.min.css" />"/>
    <![endif]-->
    <link rel="stylesheet" href="<c:url value="/resources/theme1/assets_admin/css/ace-rtl.min.css"/>" />

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="/resources/theme1/assets_admin/css/ace-ie.min.css" />
    <![endif]-->

    <!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->

    <!--[if lte IE 8]>
    <script src="/resources/theme1/assets_admin/js/html5shiv.min.js"></script>
    <script src="/resources/theme1/assets_admin/js/respond.min.js"></script>
    <![endif]-->
</head>
...
<%--                                                <p style="color: red">${message}</p>--%>
                                ...
                                <div class="toolbar clearfix">
                                    ...
                                    <div>
                                        <a href="${pageContext.request.contextPath}/register" data-target="#signup-box" class="user-signup-link">
                                            I want to register
...
<!--[if !IE]> -->
<script src="/resources/theme1/assets_admin/js/jquery-2.1.4.min.js"></script>

<!-- <![endif]-->

<!--[if IE]>
<script src="/resources/theme1/assets_admin/js/jquery-1.11.3.min.js"></script>
<![endif]-->
