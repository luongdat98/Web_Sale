            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="<c:url value="/resources/theme1/assets_admin/images/avatars/user.jpg" />"
                             alt="Jason's Photo"/>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<c:url value="/getAllBrands"/>">Quản lý nhà sản xuất</a>
                    </li>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
<%--                        <c:url value="/admin/brand/addBrand" var="url"></c:url>--%>
                        <form:form method="post" modelAttribute="brandFormObj"
                                   enctype="multipart/form-data" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="name">Tên nhà sản
                                    xuất: </label>

                                <div class="col-sm-9">
                                    <form:input path="name" type="text" id="nameBrand"
                                                placeholder="Vui lòng nhập tên nhà sản xuất" class="col-xs-10"/>
                                    <br><br>                                    <span id="nameBrandEr" style="color: #ff0000"></span>

                                    <form:errors  id="status" path="name" cssClass="error"/> <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <form:input multiple="multiple" path="logo" type="file" name="upload" id="form-field-2"
                                                class="col-xs-10" />
                                </div>
                            </div>
...
<script type="text/javascript">
    $('document').ready(function () {
        $("#nameBrand").blur(function () {
            var nameBrand = $('#nameBrand').val();
            if(nameBrand ==''){
                $('#nameBrandEr').html("Không được bỏ trống");
            }

            $.ajax({
                type: 'POST',
                url:  "${pageContext.request.contextPath }/admin/brand/checkNameBrand",
                data: {
                    'nameBrand': nameBrand,
                },
                success: function (response) {
                    if (response == 'exist') {
                        $('#nameBrandEr').html("Nhà sản xuất đã tồn tại");
                    } else {
                        $('#nameBrandEr').html("");
                    }
                    if (nameBrand == '') {
