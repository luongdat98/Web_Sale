...
<%--                                            </th>--%>
                                        ...
                                        <c:forEach items="${product}" var="product">
                                            <c:choose>
                                            <c:when test="${product.activeFlag==1}">
                                            <!--                                        Dòng thứ nhất-->
                                            <tr>
                                                <td class="center">
                                                    <label class="pos-rel">
                                                ...
                                                <td class="hidden-320"><img src="<c:url value="/resources/image/product/pro${product.id}.jpg"/>"
                                                                            style="max-height:60px" alt="${product.imgMain}" /></td>
                                                <td >${product.name}</td>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        ...
                                                        <a class="green" href="<c:url value="/admin/editProduct/${product.id}" />">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a onclick="return confirm('Bạn chắc chắn xóa? '+'${product.name}');" class="red" href="<c:url value="/admin/delete1/${product.id}" />" >
