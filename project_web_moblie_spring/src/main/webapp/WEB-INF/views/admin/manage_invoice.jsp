							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<!--===========================Phần bài làm ==========================-->
										<div class="row">
											<!----------------- Div form tìm kiếm---------->
											<div class="col-xs-12 myformsearch">
												<form class="form-inline my-2 my-lg-0">
													<input class="form-control mr-sm-2 mysearch" type="search" placeholder="Nhập tên hoặc Mã ĐH..." aria-label="Search">
													<span class="createdate">Từ ngày</span>
                                                    <input type="date" id="createdate">
													<span class="updatedate">Đến ngày</span>
											...
											<div class="col-xs-12">
												...
												<div>
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														...
														<c:forEach var="in" items="${listInvoiceDetail}">
														<tr>
															<td class="center">
																<label class="pos-rel">
																	<input type="checkbox" class="ace" />
															...
															<td>${in.invoice.id}</td>
															<td>${in.invoice.name}</td>
															<td>${in.invoice.users.name}</td>
															<td>
																<c:choose>
																	<c:when test="${in.invoice.activeFlag < 1}">Đơn hàng cũ</c:when>
																	<c:otherwise>Đơn hàng mới</c:otherwise>
																</c:choose>
																<p>${in.invoice.createDate}</p></td>
															<td><fmt:formatNumber value="${in.price * in.invoice.quantity}" type="currency"/><td>
																<div class="hidden-sm hidden-xs action-buttons">
																	<a class="blue" href="<c:url value="/admin/invoiceDetail/getInvoiceDetailById/${in.invoice.id}" />">
