            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form:form method="post" action="${url}" commandName="editProductObj" enctype="multipart/form-data" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tên sản phẩm: </label>

                                <div class="col-sm-9">
                                    <form:input path="name" type="text" id="form-field-1" placeholder="Vui lòng nhập tên sản phẩm" class="col-xs-10" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <form:input path="imgMain" type="file" name="image" id="image" class="col-xs-10"/>
                                </div>
                            </div>
